    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Teachers / Add New Teacher</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="card-body pt-3">
                <form action="{{ route('teachers.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required placeholder="Enter teacher name..." autocomplete="name" autofocus/>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('employe_id') is-invalid @enderror" name="employe_id" value="{{ old('employe_id') }}" required placeholder="Enter employe id..." autocomplete="employe_id" autofocus/>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email"  value="{{ old('email') }}" required placeholder="Enter teacher email..." autocomplete="email" autofocus/>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <textarea  class="form-control @error('address') is-invalid @enderror" name="address"  value="{{ old('address') }}" required autocomplete="address" autofocus>
                            </textarea>
                            @error('address')
                            <span class="text-danger">
                                <strong>{{ $message }}</strong>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input type="file" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ old('image') }}" required autocomplete="image" autofocus disabled/>
